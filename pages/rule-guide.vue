...
.outframe
  .contentframe
    .inframe
      ...
      talk(handle="ELSE" deco="sow" face_id="c96" head="学者 レオナルド", :write_at="1370662886001")
        p.
      ...
      talk(handle="ELSE" deco="sow" face_id="c96" head="学者 レオナルド", :write_at="1370662886002")
        p.
      ...
      talk(handle="ELSE" deco="sow" face_id="c96" head="学者 レオナルド", :write_at="1370662886003")
        p.
      ...
      talk(handle="GSAY" deco="head" face_id="t07" head="勧善懲悪委 アカリ", :write_at="1437461000000")
        p.
          突然死は悪！そうですよね先生！

          みんな一生懸命がんばっているのに、そんなことで汚されるの、悔しいです！

      talk(handle="ELSE" deco="sow" face_id="c96" head="学者 レオナルド", :write_at="1437461000000")
        p.
          正解、国のルールだね。
      ...
      talk(handle="GSAY" deco="sow" face_id="g02" head="白鶴拳 志偉", :write_at="1437461000000")
        p.
      ...
      talk(handle="GSAY" deco="sow" face_id="t01" head="友愛組合 チアキ", :write_at="1437461000000")
        p.
      ...
      talk(handle="GSAY" deco="sow" face_id="c24" head="長老 ナタリア", :write_at="1437461000000")
        p.
      ...
      talk(handle="WSAY" deco="sow" face_id="t10" head="営利政府 トレイル", :write_at="1437461000000")
        p.
          ...
          ぜひご覧ください。
      report(v-for="o, idx in maker.list" handle="P01", :head="o.head", :log="o.log", :key="idx")
